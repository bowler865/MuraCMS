...
--->
	...
	<cffunction name="getTabList" output="false">
		<cfreturn "Primary,Basic,Summary,Image,Publishing,Scheduling,List Display Options,Layout,Categorization,Tags,Related Content,Remote,Extended Attributes,Usage Report">
	</cffunction>
